...
<head>
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="<?= base_url('assets/landing') ?>/img/logo4.png" />
    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-1" href="index.html"><img src="<?= base_url('assets/landing') ?>/img/logo4.png" class="mr-2" alt="logo" />JWP WO</a>
                <a class="navbar-brand brand-logo-mini" href="index.html"><img src="<?= base_url('assets/landing') ?>/img/logo4.png" alt="logo" /></a>
            </div>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                            <img src="<?= base_url('assets/admin/') ?>images/faces/face26.jpg" alt="profile" />
                        </a>
